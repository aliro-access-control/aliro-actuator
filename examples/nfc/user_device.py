...
from aliro_actuator.access_protocol.user_device import UserDevice, UserStorage
...
from examples.nfc.common import (
    KPERSISTENT,
    READER_GROUP_IDENTIFIER,
    READER_SUB_GROUP_IDENTIFIER,
)
...
if __name__ == "__main__":
    ...
    userstorage.add_kpersistent(KPERSISTENT, READER_SUB_GROUP_IDENTIFIER)
