...
[Issue Tracker](ISSUE TRACKER Weblink), as well
...
[submitting a GitHub Issue](https://github.com/aliro-access-control/aliro-actuator/issues/new).
...
you can [submit a Pull Request](https://github.com/aliro-access-control/aliro-actuator/compare) with a fix.
...
-   _Large feature_: first
    [submit a GitHub Issue](https://github.com/aliro-access-control/aliro-actuator/issues/new)
...
-   _Small feature_: can be implemented and directly
    [submitted as a Pull Request](https://github.com/aliro-access-control/aliro-actuator/compare).
...
```bash
# Clone your fork
git clone git@github.com:aliro-access-control/aliro-actuator.git

# Configure upstream alias
git remote add upstream git@github.com:aliro-access-control/aliro-actuator.git
```
